...
| :--- | :--- | :--- |
| **`docs/`** | Official, validated documentation and service flows. | Permanent and official files only. |
| **`fleeting-tasks/`** | **Mandatory Inbox.** Initial discovery and project drafts. | ALL new files/tasks MUST start here. |
| **`references/`** | External research, raw data, and GSD system documentation. | Investigation artifacts and tool READMEs. |

### Key Documentation Files
*   **`docs/COGNITIONBASE-GLOBAL-INFO.md`**: Mission, vision, and high-level service definitions.
